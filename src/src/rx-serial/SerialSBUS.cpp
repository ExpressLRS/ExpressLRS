...
uint32_t SerialSBUS::sendRCFrame(bool frameAvailable, bool frameMissed, uint32_t *channelData)
{
...
#endif
    {
        ...
        PackedRCdataOut.ch6 = fmap(channelData[7], CRSF_CHANNEL_VALUE_STD_MIN, CRSF_CHANNEL_VALUE_STD_MAX, US_CHANNEL_VALUE_DJI_RCS_MIN, US_CHANNEL_VALUE_DJI_RCS_MAX); // Recenter and Selfie
