...
{
    const uint32_t constrainedValue = constrain(value, CRSF_CHANNEL_VALUE_STD_MIN, CRSF_CHANNEL_VALUE_STD_MAX);
    return fmap(constrainedValue, CRSF_CHANNEL_VALUE_STD_MIN, CRSF_CHANNEL_VALUE_STD_MAX, 0, 0xFF);
}
