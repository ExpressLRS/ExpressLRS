...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {3, RATE_LORA_500HZ,  -105,  1665, 2500, 2500,  3, 5000,  4*4, 9*4},
    {4, RATE_LORA_250HZ,  -108,  3300, 3000, 2500,  6, 5000,  2*4, 9*4},
    {5, RATE_LORA_150HZ,  -112,  5871, 3500, 2500, 10, 5000, -1*4, 8*4},
    {6, RATE_LORA_50HZ,   -117, 18443, 4000, 2500,  0, 5000, -2*4, 6*4}};
#endif
