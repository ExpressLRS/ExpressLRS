...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {1, RATE_250HZ, -112, 4380, 3500, 1000, 2000, 5000}, // ~ 3 sync packets
    {2, RATE_150HZ, -117, 8770, 3500, 4000, 2000, 5000},
    {3, RATE_50HZ, -120, 17540, 3500, 6000, 2000, 5000}}; // this means always send sync on ch[0] as soon as we can
