...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    {0, RATE_LORA_200HZ, -112,  4380, 3000, 2500, 600, 5000, -1*DYNPOWER_MEAN_ACCUMULATOR_MUL,  2*DYNPOWER_MEAN_ACCUMULATOR_MUL},
    {1, RATE_LORA_100HZ, -117,  8770, 3500, 2500, 600, 5000, -3*DYNPOWER_MEAN_ACCUMULATOR_MUL,  1*DYNPOWER_MEAN_ACCUMULATOR_MUL},
    {2, RATE_LORA_50HZ,  -120, 18560, 4000, 2500, 600, 5000, -4*DYNPOWER_MEAN_ACCUMULATOR_MUL,  0*DYNPOWER_MEAN_ACCUMULATOR_MUL},
    {3, RATE_LORA_25HZ,  -123, 29950, 6000, 4000,   0, 5000, -5*DYNPOWER_MEAN_ACCUMULATOR_MUL, -1*DYNPOWER_MEAN_ACCUMULATOR_MUL}};
#endif
...
<<<<<<< HEAD
    {2, RATE_LORA_500HZ,  -105,  1665, 2500, 2500,  3, 5000, 4*DYNPOWER_MEAN_ACCUMULATOR_MUL, 9*DYNPOWER_MEAN_ACCUMULATOR_MUL},
    {3, RATE_LORA_250HZ,  -108,  3300, 3000, 2500,  6, 5000, 2*DYNPOWER_MEAN_ACCUMULATOR_MUL, 9*DYNPOWER_MEAN_ACCUMULATOR_MUL},
    {4, RATE_LORA_150HZ,  -112,  5871, 3500, 2500, 10, 5000, -1*DYNPOWER_MEAN_ACCUMULATOR_MUL, 8*DYNPOWER_MEAN_ACCUMULATOR_MUL},
    {5, RATE_LORA_50HZ,   -117, 18443, 4000, 2500,  0, 5000, -2*DYNPOWER_MEAN_ACCUMULATOR_MUL, 6*DYNPOWER_MEAN_ACCUMULATOR_MUL}};
=======
...
>>>>>>> parent of baccda37 (Update the thresholds for 2.4g 150 and 50 Hz)
#endif
