...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    {0, RATE_LORA_200HZ, -112,  1,  4380, 3000, 2500, 600, 5000},
    {1, RATE_LORA_100HZ, -117,  0,  8770, 3500, 2500, 600, 5000},
    {2, RATE_LORA_50HZ,  -120, -1, 18560, 4000, 2500, 600, 5000},
    {3, RATE_LORA_25HZ,  -123, -2, 29950, 6000, 4000,   0, 5000}};
#endif
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    {0, RATE_FLRC_1000HZ, -104, DYNPOWER_UPTHRESH_SNR_NONE, 389, 2500, 2500,  3, 5000},
    {1, RATE_FLRC_500HZ,  -104, DYNPOWER_UPTHRESH_SNR_NONE, 389, 2500, 2500,  3, 5000},
    {2, RATE_LORA_500HZ,  -105, 4,  1665, 2500, 2500,  3, 5000},
    {3, RATE_LORA_250HZ,  -108, 2,  3300, 3000, 2500,  6, 5000},
    {4, RATE_LORA_150HZ,  -112, 0,  5871, 3500, 2500, 10, 5000},
    {5, RATE_LORA_50HZ,   -117, 0, 18443, 4000, 2500,  0, 5000}};
#endif
