...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
                                                        //  b/s, BWF, FDev
    {0,  RADIO_TYPE_LR1121_LORA_900,  RATE_LORA_200HZ,      36, 0x19, 100,    16,  36, 0x19, 100,    16, TLM_RATIO_1_64,  4,  5000, OTA4_PACKET_SIZE, 1},
    {1,  RADIO_TYPE_LR1121_LORA_900,  RATE_LORA_100HZ_8CH,  20, 0x0A, 100,    16,  20, 0x0A, 100,    16, TLM_RATIO_1_32,  4, 10000, OTA8_PACKET_SIZE, 1},
    {2,  RADIO_TYPE_LR1121_LORA_900,  RATE_LORA_100HZ,      18, 0x0A, 100,    16,  18, 0x0A, 100,    16, TLM_RATIO_1_32,  4, 10000, OTA4_PACKET_SIZE, 1},
    {3,  RADIO_TYPE_LR1121_LORA_900,  RATE_LORA_50HZ,        9, 0x0A, 100,    16,   9, 0x0A, 100,    16, TLM_RATIO_1_16,  4, 20000, OTA4_PACKET_SIZE, 1},
    {4,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_500HZ,     100, 0x19, 100,    16, 100, 0x19, 100,    16, TLM_RATIO_1_128, 4,  2000, OTA4_PACKET_SIZE, 1},
    {5,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_333HZ_8CH,  75, 0x19, 100,    16,  75, 0x19, 100,    16, TLM_RATIO_1_128, 4,  3003, OTA8_PACKET_SIZE, 1},
    {6,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_250HZ,      50, 0x19, 100,    16,  50, 0x19, 100,    16, TLM_RATIO_1_64,  4,  4000, OTA4_PACKET_SIZE, 1},
    {7,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_150HZ,      30, 0x0A, 100,    16,  30, 0x0A, 100,    16, TLM_RATIO_1_32,  4,  6666, OTA4_PACKET_SIZE, 1},
    {8,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_100HZ_8CH,  20, 0x0A, 100,    16,  20, 0x0A, 100,    16, TLM_RATIO_1_32,  4, 10000, OTA8_PACKET_SIZE, 1},
    {9,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_50HZ,        9, 0x0A, 100,    16,   9, 0x0A, 100,    16, TLM_RATIO_1_16,  2, 20000, OTA4_PACKET_SIZE, 1},
    {10, RADIO_TYPE_LR1121_LORA_900,  RATE_FLRC_1000HZ,    200, 0x09, 100,    16, 200, 0x09, 100,    16, TLM_RATIO_1_32,  4,  1000, OTA4_PACKET_SIZE, 1},
    {11, RADIO_TYPE_LR1121_LORA_900,  RATE_FLRC_1000HZ,    255, 0x09, 100,    16, 255, 0x09, 100,    16, TLM_RATIO_1_32,  4,  1000, OTA8_PACKET_SIZE, 1},
    {12, RADIO_TYPE_LR1121_LORA_2G4,  RATE_FLRC_1000HZ,    200, 0x09, 100,    16, 200, 0x09, 100,    16, TLM_RATIO_1_64,  4,  1000, OTA4_PACKET_SIZE, 1},
    {13, RADIO_TYPE_LR1121_LORA_2G4,  RATE_DVDA_500HZ,     200, 0x09, 100,    16, 200, 0x09, 100,    16, TLM_RATIO_1_64,  4,  1000, OTA4_PACKET_SIZE, 2}};
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {10, RATE_LORA_150HZ,     -112,  5871, 3500, 2500,   3,  5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
    {11, RATE_LORA_100HZ_8CH, -112,  7456, 3500, 2500,   3,  5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
    {12, RATE_LORA_250HZ,     -111,  3216, 3500, 2500,   3,  5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
    {13, RATE_LORA_200HZ_8CH, -111,  4240, 3500, 2500,   3,  5000, SNR_SCALE( 1), SNR_SCALE(3.0)}};
#endif
