...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    {0, RADIO_TYPE_LORA, RATE_LORA_333HZ_8CH, SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_5, TLM_RATIO_1_64, 4,  3003,  8, OTA4_PACKET_SIZE, 1},
    {1, RADIO_TYPE_LORA, RATE_LORA_250HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_8, TLM_RATIO_1_64, 4,  4000,  8, OTA4_PACKET_SIZE, 1},
    {2, RADIO_TYPE_LORA, RATE_LORA_100HZ_8CH, SX126x_LORA_BW_500, SX126x_LORA_SF6, SX126x_LORA_CR_4_8, TLM_RATIO_1_32, 4, 10000,  8, OTA8_PACKET_SIZE, 1},
    {3, RADIO_TYPE_LORA, RATE_LORA_100HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF7, SX126x_LORA_CR_4_7, TLM_RATIO_1_32, 4, 10000,  8, OTA4_PACKET_SIZE, 1},
    {4, RADIO_TYPE_LORA, RATE_LORA_50HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF8, SX126x_LORA_CR_4_7, TLM_RATIO_1_16, 4, 20000, 10, OTA4_PACKET_SIZE, 1},
    {5, RADIO_TYPE_LORA, RATE_LORA_25HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF9, SX126x_LORA_CR_4_7, TLM_RATIO_1_8,  2, 40000, 10, OTA4_PACKET_SIZE, 1}};

expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    {0, RATE_LORA_333HZ_8CH, -111,  2640, 2500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)}, // TODO - SNR thresholds need to be checked.
    {1, RATE_LORA_250HZ,     -111,  3216, 3000, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
    ...
    {5, RATE_LORA_25HZ,      -123, 29950, 6000, 4000,   0, 5000, SNR_SCALE(-3), SNR_SCALE(0.5)}};
#endif
...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    {0, RADIO_TYPE_LORA, RATE_LORA_200HZ,     SX127x_BW_500_00_KHZ, SX127x_SF_6, SX127x_CR_4_7, TLM_RATIO_1_64, 4,  5000,  8, OTA4_PACKET_SIZE, 1},
    {1, RADIO_TYPE_LORA, RATE_LORA_100HZ_8CH, SX127x_BW_500_00_KHZ, SX127x_SF_6, SX127x_CR_4_8, TLM_RATIO_1_32, 4, 10000,  8, OTA8_PACKET_SIZE, 1},
    {2, RADIO_TYPE_LORA, RATE_LORA_100HZ,     SX127x_BW_500_00_KHZ, SX127x_SF_7, SX127x_CR_4_7, TLM_RATIO_1_32, 4, 10000,  8, OTA4_PACKET_SIZE, 1},
    {3, RADIO_TYPE_LORA, RATE_LORA_50HZ,      SX127x_BW_500_00_KHZ, SX127x_SF_8, SX127x_CR_4_7, TLM_RATIO_1_16, 4, 20000, 10, OTA4_PACKET_SIZE, 1},
    {4, RADIO_TYPE_LORA, RATE_LORA_25HZ,      SX127x_BW_500_00_KHZ, SX127x_SF_9, SX127x_CR_4_7, TLM_RATIO_1_8,  2, 40000, 10, OTA4_PACKET_SIZE, 1}};
...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    {0, RADIO_TYPE_FLRC, RATE_FLRC_1000HZ,    SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2,    TLM_RATIO_1_128, 2,  1000, 32, OTA4_PACKET_SIZE, 1},
    {1, RADIO_TYPE_FLRC, RATE_FLRC_500HZ,     SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2,    TLM_RATIO_1_128, 2,  2000, 32, OTA4_PACKET_SIZE, 1},
    {2, RADIO_TYPE_FLRC, RATE_DVDA_500HZ,     SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2,    TLM_RATIO_1_128, 2,  1000, 32, OTA4_PACKET_SIZE, 2},
    {3, RADIO_TYPE_FLRC, RATE_DVDA_250HZ,     SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2,    TLM_RATIO_1_128, 2,  1000, 32, OTA4_PACKET_SIZE, 4},
    {4, RADIO_TYPE_LORA, RATE_LORA_500HZ,     SX1280_LORA_BW_0800,         SX1280_LORA_SF5,  SX1280_LORA_CR_LI_4_6, TLM_RATIO_1_128, 4,  2000, 12, OTA4_PACKET_SIZE, 1},
    {5, RADIO_TYPE_LORA, RATE_LORA_333HZ_8CH, SX1280_LORA_BW_0800,         SX1280_LORA_SF5,  SX1280_LORA_CR_LI_4_7, TLM_RATIO_1_128, 4,  3003, 12, OTA8_PACKET_SIZE, 1},
    {6, RADIO_TYPE_LORA, RATE_LORA_250HZ,     SX1280_LORA_BW_0800,         SX1280_LORA_SF6,  SX1280_LORA_CR_LI_4_7, TLM_RATIO_1_64,  4,  4000, 14, OTA4_PACKET_SIZE, 1},
    {7, RADIO_TYPE_LORA, RATE_LORA_150HZ,     SX1280_LORA_BW_0800,         SX1280_LORA_SF7,  SX1280_LORA_CR_LI_4_7, TLM_RATIO_1_32,  4,  6666, 12, OTA4_PACKET_SIZE, 1},
    {8, RADIO_TYPE_LORA, RATE_LORA_100HZ_8CH, SX1280_LORA_BW_0800,         SX1280_LORA_SF7,  SX1280_LORA_CR_LI_4_7, TLM_RATIO_1_32,  4, 10000, 12, OTA8_PACKET_SIZE, 1},
    {9, RADIO_TYPE_LORA, RATE_LORA_50HZ,      SX1280_LORA_BW_0800,         SX1280_LORA_SF8,  SX1280_LORA_CR_LI_4_7, TLM_RATIO_1_16,  2, 20000, 12, OTA4_PACKET_SIZE, 1}};
