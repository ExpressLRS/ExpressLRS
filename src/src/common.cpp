...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    ...
    {10, RADIO_TYPE_LR1121_LORA_900,  RATE_FSK_900_1000HZ,     200, 0x09, 100,    16, 200, 0x09, 100,    16, TLM_RATIO_1_128,  4,  1000, OTA4_PACKET_SIZE, 1},
    {11, RADIO_TYPE_LR1121_LORA_900,  RATE_FSK_900_1000HZ_8CH, 255, 0x09, 100,    16, 255, 0x09, 100,    16, TLM_RATIO_1_128,  4,  1000, OTA8_PACKET_SIZE, 1},
    {12, RADIO_TYPE_LR1121_LORA_2G4,  RATE_FSK_2G4_1000HZ,     200, 0x09, 100,    16, 200, 0x09, 100,    16, TLM_RATIO_1_128,  4,  1000, OTA4_PACKET_SIZE, 1},
    {13, RADIO_TYPE_LR1121_LORA_2G4,  RATE_FSK_2G4_DVDA_500HZ, 200, 0x09, 100,    16, 200, 0x09, 100,    16, TLM_RATIO_1_128,  4,  1000, OTA4_PACKET_SIZE, 2},
    {14, RADIO_TYPE_LR1121_LORA_900,  RATE_LORA_250HZ,     LR11XX_RADIO_LORA_BW_500, LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_4_8,     8, LR11XX_RADIO_LORA_BW_500, LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_4_8,     8, TLM_RATIO_1_64,  4,  4000, OTA4_PACKET_SIZE, 1},
    {15, RADIO_TYPE_LR1121_LORA_900,  RATE_LORA_200HZ_8CH, LR11XX_RADIO_LORA_BW_500, LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_4_7,     8, LR11XX_RADIO_LORA_BW_500, LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_4_7,     8, TLM_RATIO_1_64,  4,  5000, OTA8_PACKET_SIZE, 1}};
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {11, -101,   658, 2500, 2500,   3,  5000, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {12, -103,   690, 2500, 2500,   3,  5000, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {13, -103,   690, 2500, 2500,   3,  5000, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE},
    {14, -111,  3216, 3500, 2500, 600,  5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
    {15, -111,  4240, 3500, 2500, 600,  5000, SNR_SCALE( 1), SNR_SCALE(3.0)}};
#endif
