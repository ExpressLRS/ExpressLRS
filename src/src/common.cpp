...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    {0, RATE_LORA_200HZ, -112,  4380, 3000, 2500, 600, 5000,  1, 5},
    {1, RATE_LORA_100HZ, -117,  8770, 3500, 2500, 600, 5000,  0, 5},
    {2, RATE_LORA_50HZ,  -120, 18560, 4000, 2500, 600, 5000, -1, 5},
    {3, RATE_LORA_25HZ,  -123, 29950, 6000, 4000,   0, 5000, -2, 5}};
#endif
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {2, RATE_LORA_500HZ,  -105,  1665, 2500, 2500,  3, 5000, 4, 10},
    {3, RATE_LORA_250HZ,  -108,  3300, 3000, 2500,  6, 5000, 2, 10},
    {4, RATE_LORA_150HZ,  -112,  5871, 3500, 2500, 10, 5000, 0, 10},
    {5, RATE_LORA_50HZ,   -117, 18443, 4000, 2500,  0, 5000, 0, 10}};
#endif
