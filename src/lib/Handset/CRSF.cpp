...
#if defined(M0139)
    // Hardware version = M184
    device->hardwareVer = htobe32(0x6D313834); // unused currently by us, seen [ 0x00, 0x0b, 0x10, 0x01 ] // "Hardware: V 1.01" / "Bootloader: V 3.06"
    device->softwareVer = htobe32(0x03040000 + MODALAI_VERSION); // seen [ 0x00, 0x00, 0x05, 0x0f ] // "Firmware: V 5.15"
#else
