...
typedef enum : uint8_t {
    ...
    CRSF_COMMAND_MODEL_SELECT_ID = 0x05,        // this is sent if ch4 arming is required
    CRSF_COMMAND_MODEL_SELECT_ID_EXT = 0x06,    // this is sent ifSF Arm logic is required and is sent
