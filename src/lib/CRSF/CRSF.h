...
public:
    ...
    void sendLUAresponse(uint8_t val[], uint8_t len, uint8_t frameType, const __FlashStringHelper *elrsInfo, uint8_t len2);
    ...
    void sendCRSFparam(uint8_t fieldid, uint8_t fieldchunk, uint8_t fieldparent, uint8_t fieldtype,const __FlashStringHelper *field_name,uint8_t namelength,uint8_t fieldsetup2[],uint8_t len_setup2,const __FlashStringHelper *field_unit, uint8_t unitlength);
