...
void SX127xDriver::Config(uint8_t bw, uint8_t sf, uint8_t cr, uint32_t regfreq,
...
{
  Config(bw, sf, cr, regfreq, PreambleLength, currSyncWord, InvertIQ, _PayloadLength, interval);
}
