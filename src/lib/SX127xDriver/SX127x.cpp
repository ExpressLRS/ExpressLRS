...
void ICACHE_RAM_ATTR SX127xDriver::SetFrequencyReg(uint32_t freq, SX1280_Radio_Number_t radioNumber)
{
  currFreq = freq;
  SetMode(SX127x_OPMODE_STANDBY);
...
void ICACHE_RAM_ATTR SX127xDriver::TXnb(uint8_t * data, uint8_t size, SX1280_Radio_Number_t radioNumber)
{
