...
private:
    ...
    void SetMode(SX1262_RadioOperatingModes_t OPmode, SX12XX_Radio_Number_t radioNumber);
    ...
    // FLRC functions
    void ConfigModParamsFLRC(uint8_t bw, uint8_t cr, uint8_t bt=SX1262_FLRC_BT_0_5);
