...
export class ElrsFooter extends LitElement {
    ...
    render() {
        return html`
            <footer id="footer" class="elrs-header" style="padding: 6px">
                <div style="align-items: center; display: flex; justify-content: space-around">
                    ...
                    <a href="https://discord.gg/dS6ReFY">
                        <svg width="24" xmlns="http://www.w3.org/2000/svg" aria-label="Discord" viewBox="0 0 512 512">
                    ...
                    <a href="https://www.facebook.com/groups/636441730280366">
                        <svg width="24" xmlns="http://www.w3.org/2000/svg" aria-label="Facebook" viewBox="0 0 512 512">
