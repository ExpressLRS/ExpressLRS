...
uint8_t SX1276begin(uint8_t nss, uint8_t dio0, uint8_t dio1) {
  ...
  // start configuration
  return (SX1276config(SX127xDriver::_bw, SX127xDriver::_sf, SX127xDriver::_cr, SX127xDriver::_freq, SX127xDriver::_syncWord)); //check to see if this needs to be changed later
}
